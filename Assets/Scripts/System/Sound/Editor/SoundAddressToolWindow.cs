...
public class SoundAddressToolWindow : EditorWindow
{
    ...
    private void GenerateAddress()
    {
        ...
        var clip_directory_path = AssetDatabase.GUIDToAssetPath(EditorDefine.Sound.CLIP_DIRECTORY_GUID);
    ...
    private void ApplyAddress()
    {
        ...
        var address_csharp_path = AssetDatabase.GUIDToAssetPath(EditorDefine.Sound.ADDRESS_CSHARP_GUID);
